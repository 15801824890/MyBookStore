...
namespace MyBookStore.Web
{
    ...
    public class MyBookStoreWebModule : AbpModule
    {
        public override void PreConfigureServices(ServiceConfigurationContext context)
        {
            context.Services.PreConfigure<AbpMvcDataAnnotationsLocalizationOptions>(options =>
            {
                options.AddAssemblyResource(
                    typeof(MyBookStoreResource),
                    typeof(MyBookStoreDomainModule).Assembly,
                    typeof(MyBookStoreDomainSharedModule).Assembly,
                    typeof(MyBookStoreApplicationModule).Assembly,
                    typeof(MyBookStoreApplicationContractsModule).Assembly,
                    typeof(MyBookStoreWebModule).Assembly
                );
            });
        }
        ...
        private void ConfigureNavigationServices()
        {
            ...
            {
                options.MenuContributors.Add(new MyBookStoreMenuContributor());
            });
        }
