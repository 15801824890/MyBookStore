...
namespace MyBookStore.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update MyBookStoreDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update MyBookStoreEfCoreEntityExtensionMappings to extend the IdentityUser entity
